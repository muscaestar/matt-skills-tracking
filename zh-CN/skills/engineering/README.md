...
- **[implement](./implement/SKILL.md)** — 构建规格或一组 ticket 所描述的工作，在预先商定的 seam 处驱动 `/tdd`，提交前用 `/code-review` 收尾。
...
- **[codebase-design](./codebase-design/SKILL.md)** — 设计深模块的共享纪律和词汇：小接口、干净的 seam、通过接口可测试。
